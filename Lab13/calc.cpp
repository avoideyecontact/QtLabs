...
void calc::on_pushButton_13_clicked()
{
    if (ui->checkBox->isChecked())
    {
        if (ui->lineEdit->text().length() != 0)
        {
            ...
            if ( ui->comboBox_2->currentText() == "килограмм" )
            {
                val = val;
            }
            else if (ui->comboBox_2->currentText() == "грамм")
            {
                val /= 1000;
            }
            else if (ui->comboBox_2->currentText() == "фунтов")
            {
                val *= 0.453592;
            }


            if ( ui->comboBox->currentText() == "килограмм" )
            {
                val = val;
            }
            else if (ui->comboBox->currentText() == "грамм")
            {
                val *= 1000;
            }
            else if (ui->comboBox->currentText() == "фунтов")
            {
                val /= 0.453592;
            }
...
void calc::on_checkBox_toggled(bool checked)
{
    stack.clear();
    ui->lineEdit->clear();
    ui->lineEdit_2->clear();
